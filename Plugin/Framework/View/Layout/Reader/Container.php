...
namespace OuterEdge\ContainerGroup\Plugin\Framework\View\Layout\Reader;

use Magento\Framework\View\Layout\Reader\Container as ReaderContainer;
...
class Container
{
    ...
    public function aroundInterpret(ReaderContainer $subject, callable $proceed, $readerContext, $currentElement)
    {
